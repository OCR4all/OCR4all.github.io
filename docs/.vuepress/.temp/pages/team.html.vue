<template><h3 id="leitung" tabindex="-1"><a class="header-anchor" href="#leitung" aria-hidden="true">#</a> Leitung</h3>
<ul>
<li>Dr. Christian Reul <a href="mailto:christian.reul@uni-wuerzburg.de?subject=ocr4all%20Kontakt">Mail</a></li>
</ul>
<h3 id="user-support" tabindex="-1"><a class="header-anchor" href="#user-support" aria-hidden="true">#</a> User Support</h3>
<ul>
<li>Florian Langhanki <a href="mailto:florian.langhanki@uni-wuerzburg.de?subject=ocr4all%20Kontakt">Mail</a></li>
<li>Annika Müller</li>
</ul>
