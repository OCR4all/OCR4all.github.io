<template><h4 id="_4-4-3specific-settings-regions-parameters-reading-order-settings" tabindex="-1"><a class="header-anchor" href="#_4-4-3specific-settings-regions-parameters-reading-order-settings" aria-hidden="true">#</a> 4.4.3	Specific settings: ‘regions’, ‘parameters’, ‘reading order’, ‘settings’</h4>
<ul>
