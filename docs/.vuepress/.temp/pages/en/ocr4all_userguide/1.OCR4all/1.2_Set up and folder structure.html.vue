...
<h2 id="_1-2set-up-and-folder-structure" tabindex="-1"><a class="header-anchor" href="#_1-2set-up-and-folder-structure" aria-hidden="true">#</a> 1.2	Set up and folder structure</h2>
