...
import { isClient, isString, noop, tryOnScopeDispose, promiseTimeout, increaseWithUnit, useTimeoutFn, watchWithFilter, tryOnMounted, createFilterWrapper, bypassFilter, createSingletonPromise, toRefs, containsProp, createEventHook, throttleFilter, timestamp, isFunction, isObject, ignorableWatch, isNumber, useIntervalFn, objectPick, pausableFilter, tryOnUnmounted, identity, clamp, pausableWatch } from '@vueuse/shared';
 ...
 * @param options
 */
function useDraggable(el, options = {}) {
    var _a, _b;
