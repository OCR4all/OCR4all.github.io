...
<span class="line"><span>    image: uniwuezpd/larex:legacy</span></span></code></pre></div><div class="info custom-block"><p class="custom-block-title">INFO</p><p>By default, the backend will automatically create an administrator account with the username <code>admin</code> and password <code>ocr4all</code>. It is highly recommended to change the password immediately after setup or change the corresponding environment variables on setup.</p></div>`,6);function _(a,R,m,u,h,E){return o(),e("div",null,[s("h1",c,[p(l(a.$frontmatter.title)+" ",1),i]),d])}const O=n(r,[["render",_]]);export{S as __pageData,O as default};
